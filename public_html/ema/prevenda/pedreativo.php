...
$segmentacao_sql = mysql_query("SELECT `segmento_2`, `loja` FROM login WHERE `B` = '$senha'");while($array_s = mysql_fetch_array($segmentacao_sql)){$segmentacao = $array_s["segmento_2"];$nome_cliente_pai = $array_s["loja"];}
...
elseif($segmentacao == "C10") { $segmentacao = "Lojas Conceito";}
...
#----------Email 1 ------------------------------------------------------------------------------------------------------------------------------------------
   ...
   $headers .= 'From: adisul@adisul.com' . "\r\n" .
               'Reply-To: adisul@adisul.com , mauricioadidas@terra.com.br' . "\r\n" .
...
#----------Email 2 ------------------------------------------------------------------------------------------------------------------------------------------
	...
	<a href=\"adisul.com/order/ordens/xls_pedido_fw12.php?npedido=$p_status_pedido&var=3\" >Download do Pedido</a>

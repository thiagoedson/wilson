...
<body><?php echo $menu_principal ;?>
  ...
  <a href="tree_hardware.php?filtro=venda" class="new_tree"  style="background-color:#009;">Equipamento</a>
...
Escolha o Filtro: <select name="filtro">
                    ...
                    <option <?php if($filtro  == "artigo")        {echo "selected=\"selected\" ";}?> value="Descricao">Descricao</option>
                  </select>

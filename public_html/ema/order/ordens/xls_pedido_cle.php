...
$atua_total_pedido = mysql_query("UPDATE pedido_cle SET `status` = '$var_pedido'  WHERE  `npedido` = '$npedido'"); 
}
$query_1 = mysql_query("SELECT * FROM pedido_cle WHERE npedido = '$npedido'") or die(mysql_error());
#-----------------------------------------------------------------------------------------------
...
//consulta sql
$SQL = "SELECT * FROM `lista_artigo_pedido_cle` WHERE npedido = '$npedido' ORDER BY data, artigo ";

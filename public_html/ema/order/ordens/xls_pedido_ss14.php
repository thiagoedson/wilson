...
$atua_total_pedido = mysql_query("UPDATE pedido_ss14 SET `status` = '$var_pedido'  WHERE  `npedido` = '$npedido'"); 
}
...
//consulta sql
$SQL = "SELECT * FROM `lista_artigo_pedido_ss14` WHERE `npedido` = '$npedido' ORDER BY `loja`, `data`, `artigo`, `tamanho`";
...
header("Content-Disposition: attachment; filename = $npedido-adisul_pedido_prevensaSS14_$nome_cliente.xls");

// montando a tabela
echo "<h1>PEDIDO PREVENDA SS14<br />

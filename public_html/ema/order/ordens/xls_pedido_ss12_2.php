...
$atua_total_pedido = mysql_query("UPDATE pedido_ss12_2 SET `status` = '$var_pedido'  WHERE  `npedido` = '$npedido'"); 
}
...
//consulta sql
$SQL = "SELECT * FROM `lista_artigo_pedido_ss12_2` WHERE `npedido` = '$npedido' ORDER BY data, artigo ";
...
// montando a tabela
echo "<h1>PEDIDO DISPONIBILIDADE FW12 <br />

...
$atua_total_pedido = mysql_query("UPDATE pedido_fw15 SET `status` = '$var_pedido'  WHERE  `npedido` = '$npedido'"); 
}
...
//consulta sql
$SQL = "SELECT * FROM `lista_artigo_pedido_fw15` WHERE `npedido` = '$npedido' ORDER BY `loja`, `data`, `artigo`, `tamanho`";
...
header("Content-Disposition: attachment; filename = $npedido-adisul_pedido_prevenda_fw15_$nome_cliente.xls");

// montando a tabela
echo "
<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" />
<h1>PEDIDO PRE-VENDA FW15<br />

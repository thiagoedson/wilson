...
$atua_total_pedido = mysql_query("UPDATE pedido SET `status` = '$var_pedido'  WHERE  `npedido` = '$npedido'"); 
}
...
//consulta sql
$SQL = "SELECT * FROM `lista_artigo_pedido` WHERE npedido = '$npedido' ORDER BY data, artigo ";
...
// montando a tabela
echo "<h1>PEDIDO DISPONIBILIDADE<br />

...
$atua_total_pedido = mysql_query("UPDATE pedido_ss15 SET `status` = '$var_pedido'  WHERE  `npedido` = '$npedido'"); 
}
...
//consulta sql
$SQL = "SELECT * FROM `lista_artigo_pedido_ss15` WHERE `npedido` = '$npedido' ORDER BY `loja`, `data`, `artigo`, `tamanho`";
...
header("Content-Disposition: attachment; filename = $npedido-adisul_pedido_prevensa_SS15_$nome_cliente.xls");

// montando a tabela
echo "
<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" />
<h1>PEDIDO PREVENDA SS15<br />
...
<table>
	<tr>
		<td colspan=\"4\">www.adisul.net</td>
	</tr>
</table> ";

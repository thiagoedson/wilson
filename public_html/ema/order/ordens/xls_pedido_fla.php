...
$atua_total_pedido = mysql_query("UPDATE pedido_fla SET `status` = '$var_pedido'  WHERE  `npedido` = '$npedido'"); 
}
...
//consulta sql
$SQL = "SELECT * FROM `lista_artigo_pedido_fla` WHERE `npedido` = '$npedido' ORDER BY `loja`, `data`, `artigo`, `tamanho`";
...
header("Content-Disposition: attachment; filename = $npedido-adisul_pedido_flamengo_$nome_cliente.xls");

// montando a tabela
$texto = "<h1>PEDIDO PRONTA-ENTREGA FLAMENGO<br />

...
$atua_total_pedido = mysql_query("UPDATE pedido_fw14golf SET `status` = '$var_pedido'  WHERE  `npedido` = '$npedido'"); 
}
...
//consulta sql
$SQL = "SELECT * FROM `lista_artigo_pedido_fw14golf` WHERE `npedido` = '$npedido' ORDER BY `loja`, `data`, `artigo`, `tamanho`";
...
//header("Content-Disposition: attachment; filename=relatorio_vendas_plugmasters_$npedido.xls");
...
// montando a tabela
echo "<h1>PEDIDO PREVENDA FW14 GOLF<br />

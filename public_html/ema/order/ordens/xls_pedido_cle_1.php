...
$atua_total_pedido = mysql_query("UPDATE pedido_cle_1 SET `status` = '$var_pedido'  WHERE  `npedido` = '$npedido'"); 
}
$query_1 = mysql_query("SELECT * FROM pedido_cle_1 WHERE npedido = '$npedido'") or die(mysql_error());
#-----------------------------------------------------------------------------------------------
...
//consulta sql
$SQL = "SELECT * FROM `lista_artigo_pedido_cle_1` WHERE npedido = '$npedido' ORDER BY data, artigo ";
...
header("Content-Disposition: attachment; filename=adisul_pedidocle1_$emxls_cliente_$npedido.xls");

...
$atua_total_pedido = mysql_query("UPDATE pedido_cle120122 SET `status` = '$var_pedido'  WHERE  `npedido` = '$npedido'"); 
}
...
while($array_xls = mysql_fetch_array($query_1)){	
	 ...
	 $emxls_cliente_filho        = $array_xls["cliente_destinatario"];
	 $emxls_data                 = $array_xls["data_1"];
...
//consulta sql
$SQL = "SELECT * FROM `lista_artigo_pedido_cle120122` WHERE `npedido` = '$npedido' ORDER BY data, artigo ";
...
// montando a tabela
echo "<h1>PEDIDO PROMOCIONAL CLE 2012 <br />

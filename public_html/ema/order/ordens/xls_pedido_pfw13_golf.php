...
$atua_total_pedido = mysql_query("UPDATE pedido_pfw13_golf SET `status` = '$var_pedido'  WHERE  `npedido` = '$npedido'"); 
}
...
//consulta sql
$SQL = "SELECT * FROM `lista_artigo_pedido_pfw13_golf` WHERE `npedido` = '$npedido' ORDER BY `loja`, `data`, `artigo`, `tamanho`";
...
header("Content-Disposition: attachment; filename = $npedido-adisul_pedido_prevensafw13_$nome_cliente.xls");

// montando a tabela
echo "<h1>PEDIDO PREVENDA FW13<br />

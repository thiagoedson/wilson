...
$atua_total_pedido = mysql_query("UPDATE pedido_cle_12012 SET `status` = '$var_pedido'  WHERE  `npedido` = '$npedido'"); 
}
$query_1 = mysql_query("SELECT * FROM pedido_cle_12012 WHERE npedido = '$npedido'") or die(mysql_error());
#-----------------------------------------------------------------------------------------------
...
//consulta sql
$SQL = "SELECT * FROM `lista_artigo_pedido_cle_12012` WHERE npedido = '$npedido' ORDER BY data, artigo ";
...
header("Content-Disposition: attachment; filename=adisul_pedido_cle12012_$npedido_$emp_loja2.xls");

// montando a tabela
echo "<h1>PEDIDO PROMOCIONAL <b style=\"color:#F00\">CLE 1</b>
<br />
N Pedido $npedido</h1>

<br />";
echo "Pedido elaborado por $emp_loja | $emxls_cliente para  $emp_loja2 | $emxls_cliente_filho <br />
Entre em contato com seu CRD para se informar como prosseguir com esse pedido.<br />
";
...
echo "<table>";
  echo "<tr>";
    ...
    echo "<td>Grade</td>";
    echo "<td>Valor/SUL</td>";
    echo "<td>Total/SUL</td>";
...
while ($rs = mysql_fetch_array($executa)){
  ...
  echo "<tr>";
    ...
    echo "<td>R$  $valor</td>";
    echo "<td>R$  $total</td>";
    echo "<td>$emxls_cliente_filho</td>";
    echo "<td>$emp_loja2</td>";
  echo "</tr>";

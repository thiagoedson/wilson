...
$atua_total_pedido = mysql_query("UPDATE pedido_ss12 SET `status` = '$var_pedido'  WHERE  `npedido` = '$npedido'"); 
}
$query_1 = mysql_query("SELECT * FROM pedido_ss12 WHERE npedido = '$npedido'") or die(mysql_error());
#-----------------------------------------------------------------------------------------------
...
//consulta sql
$SQL = "SELECT * FROM `lista_artigo_pedido_ss12` WHERE npedido = '$npedido' ORDER BY data, artigo ";
...
// montando a tabela
echo "<h1>PEDIDO DISPONIBILIDADE SS12 JAN - JUN<br />

...
$atua_total_pedido = mysql_query("UPDATE pedido_acesso SET `status` = '$var_pedido'  WHERE  `npedido` = '$npedido'"); 
}
...
//consulta sql
$SQL = "SELECT * FROM `lista_artigo_pedido_acesso` WHERE `npedido` = '$npedido' ORDER BY `loja`, `data`, `artigo`, `tamanho`";
...
header("Content-Disposition: attachment; filename = $npedido-adisul_pedido_acessorestritocle1_$nome_cliente.xls");

// montando a tabela
echo "<h1>PEDIDO ACESSO RESTRITO CLE 1 <br />

...
$atua_total_pedido = mysql_query("UPDATE pedido_prontaentregagolf SET `status` = '$var_pedido'  WHERE  `npedido` = '$npedido'"); 
}
...
//consulta sql
$SQL = "SELECT * FROM `lista_artigo_pedido_prontaentregagolf` WHERE `npedido` = '$npedido' ORDER BY `loja`, `data`, `artigo`, `tamanho`";
...
header("Content-Disposition: attachment; filename = $npedido-adisul_pedido_prontaentregagolf_$nome_cliente.xls");

// montando a tabela
$texto = "<h1>PEDIDO PRONTA-ENTREGA GOLF<br />
N pedido <b style=\"color:#F00\"> $npedido</b></h1>
Pedido elaborado por $nome_cliente/$emxls_cliente.<br />
...
<b style=\"color:#F00\"> Observação: $emxls_obs </b>
<br />
<br />";

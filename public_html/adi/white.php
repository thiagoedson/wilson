...
<table width="100%" bgcolor="#FFFFFF" align="left">
  <tr bgcolor="#FF0000">
    <td colspan="7" align="center"><b>Master List | Acesso Completo</b></td>
  </tr>
   <tr>
    <td>Cód Cliente</td><td>Grupo do Site</td><td>CNPJ</td><td>Senha</td><td>Comprador</td><td align="center">Status</td><td>Email</td>
  </tr>
<?php
$query_site2 = mysqli_query($con,"SELECT * FROM login WHERE status = '1' ORDER BY nome") or die(mysql_error());
#-----------------------------------------------------------------------------------------------

...
<div id="campo_novo" style="background-color:#FFF;">


<table width="100%" align="left" style="background-color:#FFF;">
  <tr bgcolor="#FF0000">
    <td colspan="7" align="center"><b>Black List | Acesso Limitado</b></td>
  </tr>
   <tr>
    <td>Cód Cliente</td><td>Grupo do Site</td><td>CNPJ</td><td>Pass</td><td>Comprador</td><td align="center">Status</td><td>Email</td>
  </tr>
<?php
$query_site2 = mysqli_query($con,"SELECT * FROM login WHERE status = '2' ORDER BY nome") or die(mysql_error());
#-----------------------------------------------------------------------------------------------
while($array_site2 = mysqli_fetch_assoc($query_site2)){	
	...
	echo "
	<tr>
    <td><a href=\"perfil.php?login=$rela_cliente\">$rela_nome</a></td><td><a href=\"pesquisa_grupo.php?search=$rela_grupo \">$rela_grupo</a></td><td>$rela_login</td><td>&nbsp;$rela_pass</td><td>&nbsp;$rela_comprador</td><td>$rela_status</td><td><a href=\"mailto:$rela_email?Subject=ADIDAS - ASSUNTO - ADISUL\">$rela_email</a></td>
    </tr>";
}
?>

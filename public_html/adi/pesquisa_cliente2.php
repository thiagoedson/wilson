...
mygrid.setHeader("Código Cliente,CNPJ/Login,Loja,Grupo do site,Status,E-mail,Segmentação");
...
mygrid.setColSorting("ro,ro,ro,ro,ro,ro,ro");
mygrid.init();
mygrid.enableAutoWidth(true);
gridQString = "grid/pes_cliente.php?star=313";//save query string to global variable (see step 5 for details)
